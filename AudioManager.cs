...
public class AudioManager : MonoBehaviour
{
    ...
    public void PlaySong(AudioClip song, float maxVolume = 0.1f, float pitch = 1f, float startingVolume = 0f, bool playOnStart = true, bool loop = true)
    {
        if(song != null)
        {
    ...
    {
        PlaySong(null, 0, 0, 0, false, false);
    }
